...
class CallController extends BaseController
{
     ...
     */
    public function createCallsViewcalldetail(
        $callSid
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createCallsViewcalls(
        $callsid
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createCallsSenddigits(
        $options
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createCallsMakervm(
        $options
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createCallsListcalls(
        $options
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createCallsInterruptcalls(
        $options
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createCallsRecordcalls(
        $options
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createCallsPlayaudios(
        $options
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createCallsVoiceeffect(
        $options
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createCallsGroupcall(
        $options
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createCallsMakecall(
        $options
    ) {
