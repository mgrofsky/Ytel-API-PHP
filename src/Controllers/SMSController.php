...
class SMSController extends BaseController
{
     ...
     */
    public function createSmsViewdetailsms(
        $messageSid
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createSmsViewsms(
        $messageSid
    ) {
     ...
     * @param string  $options['from']     (optional) Filter SMS message objects from this valid 10-digit phone number
     *                                     (E.164 format).
     * @param string  $options['to']       (optional) Filter SMS message objects to this valid 10-digit phone number (E.
     *                                     164 format).
     * @param string  $options['dateSent'] (optional) Filter sms message objects by this date.
     * @return string response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createSmsGetinboundsms(
        $options
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createSmsListsms(
        $options
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createSmsSendsms(
        $options
    ) {
