...
class TranscriptionController extends BaseController
{
     ...
     */
    public function createTranscriptionsAudiourltranscription(
        $audiourl
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createTranscriptionsRecordingtranscription(
        $recordingSid
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createTranscriptionsViewtranscription(
        $transcriptionsid
    ) {
     ...
     * @throws APIException Thrown if API call fails
     */
    public function createTranscriptionsListtranscription(
        $options
    ) {
